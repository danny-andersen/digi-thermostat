...
#define LOCAL_TEMP_ADJUST 5               // Local thermister reads 0.5C over - so reduce reading
...
#define NETWORK_DOWN_LIMIT 300000UL    // Wait 5 mins for Network to come up otherwise reboot
